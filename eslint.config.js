...
export default [// NOTE: Opinionated
...antfu, // NOTE: Global
...tseslint.configs.recommendedTypeChecked, ...tseslint.configs.strictTypeChecked, ...tseslint.configs.stylisticTypeChecked, ...tseslint.configs.all, js.configs.all, eslintPluginUnicorn.configs.all, eslintPluginUnicorn.configs.recommended, {
  rules: {
...
}, perfectionist.configs["recommended-natural"], pluginSecurity.configs.recommended, // NOTE: Web Components
wc["flat/recommended"], wc["flat/best-practice"], {
  plugins: {
...
}, eslintPluginImportX.flatConfigs.recommended, eslintPluginImportX.flatConfigs.typescript, eslintPluginImportX.flatConfigs.errors, eslintPluginImportX.flatConfigs.warnings, {
  rules: {
...
...pluginMicrosoftSdl.configs.typescript, ...pluginMicrosoftSdl.configs.common, // NOTE: `Array` functions
{
  plugins: {
...
biome, ...oxlint.buildFromOxlintConfigFile(
...
...pluginVue.configs["flat/essential"], ...pluginVue.configs["flat/recommended"], ...pluginVue.configs["flat/strongly-recommended"], ...pluginVueA11y.configs["flat/recommended"], ...eslintPluginVueScopedCSS.configs["flat/recommended"], {
  files: ["*.vue", "**/*.vue"],
